...
const DocumentsPage = async () => {
    ...
    if (documents.length == 0) {
        return (
          <AppContainer 
            ...
            body={
            <EmptyState title="No documents found" subtitle="Start by creating a project, then a document"/>
          }
          />
        )
      }
    ...
    return (
        ...
        currentUser={currentUser}
        documents={documents}
        body={<ProjectPageClient projectTitle="My Documents" documents={documents}/>}
        />
    );
}
